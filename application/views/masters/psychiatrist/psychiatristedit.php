 ...
 <div class="container-fluid my-3">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <?php
                      if(count($psychiatrist) >0) {
                        ?>
                          <div class="card-body">
                            <div class="card-title">Edit Psychiatrist</div>
                            <?php
                            ...
                            ?>
                              <form id="coupons" method="post" style="margin-top:40px" enctype="multipart/form-data">
                                  ...
                                  <input type="hidden" name="cid" value="<?= $psychiatrist[0]->p_id;?>">
                                  <div class="row">
                                               ...
                                               <?php
                                                if(count($cities) >0) {
                                                  foreach ($cities as $key => $city) {
                                                    ?>
                                                    <option value="<?= $city->id; ?>" <?php if($psychiatrist[0]->city_id == $city->id) {echo "selected";}?>><?= $city->cname; ?></option>
                                                    <?php
                                                  }
                                                }
                                               ?>
                                  ...
                                  <div class="col-xs-12 col-sm-4 col-lg-4 col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control"  placeholder="Enter Name" value="<?= $psychiatrist[0]->dname;?>">
                                  ...
                                  <div class="col-xs-12 col-sm-4 col-lg-4 col-md-4">
                                     <div class="form-group">
                                       <label>Experience<span style="color:red">*</span></label> 
                                             <input type="text" name="experience" id="experience" class="form-control" placeholder="Enter Experience" value="<?= $psychiatrist[0]->experience;?>">
                                 ...
                                 <div class="clearfix"></div>
                                  ...
                                  <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                       ...
                                       <label>Field of Study<span style="color:red">*</span></label> 
                                             <input type="text" name="fstudy" id="fstudy" class="form-control" placeholder="Enter Field of Study" value="<?= $psychiatrist[0]->fstudy;?>">
                                  ...
                                  <div class="col-xs-12 col-sm-4 col-lg-4 col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="number" name="phone" id="phone" class="form-control"  placeholder="Enter Mobile Number" min="0" maxlength="10" minlength="10" pattern="/^-?\d+\.?\d*$/" onkeypress="if(this.value.length==10) return false;" value="<?= $psychiatrist[0]->phone;?>">
                        ...
                        redirect(base_url().'psychiatrist');
                      }
                    ?>
                </div>
            </div>
