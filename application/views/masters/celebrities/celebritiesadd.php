 ...
 <div class="container-fluid my-3">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                            <div class="card-title">Add Celebrity</div>
                            <?php
                                               ...
                                               <?php
                                                if(count($arttype) >0) {
                                                  foreach ($arttype as $key => $art) {
                                                    ?>
                                                    <option value="<?= $art->art_id; ?>"><?= $art->art_name; ?></option>
                                                    <?php
                                                  }
                                                }
                                               ?>
                                 ...
                                 <div class="clearfix"></div>
                                  ...
                                  <div class="col-xs-12 col-sm-4 col-lg-4 col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="number" name="totalfans" id="totalfans" class="form-control"  placeholder="Enter Total Fans">
