 ...
 <div class="container-fluid my-3">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="card-title">Police Station</div>
                        <?php 
                        ...
                        <a class="btn btn-success" href="<?= base_url().'policeadd';?>" style="float: right;margin-bottom: 20px;margin-right: 20px"><i class="fa fa-plus"></i> Add Station</a>
                        <br /><br /><br />
                            <table id="category_table" class="table display table-bordered table-striped no-wrap" style="width:100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Action</th>
                                         <th>Station Name</th> 
                                         <th>Station Incharge Officer</th> 
                                       <!--  <th>Image</th> -->
                                        <th>phoneno</th>
    ...
    var dataTable, edit_data;
            function initialiseData(){
                dataTable = $('#category_table').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?=base_url().'master/getPolicelist'?>",  
                        type:"POST",
                        data: function(d){
            ...
            initialiseData();
                ...
                function updateStatus(id,status){
                       var postdata = { id : id,status : status,"<?= $this->security->get_csrf_token_name();?>":$(".csrf_token").val() } ;
                        ...
                        $.ajax({                        
                            url: "<?=base_url().'master/setpoliceStatus'?>",
                            type: "post",
                            data:  postdata ,
                            dataType : 'json',
