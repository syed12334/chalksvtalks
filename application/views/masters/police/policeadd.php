                              ...
                              <form id="coupons" method="post" style="margin-top:40px" enctype="multipart/form-data">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                       <div class="form-group">
                                          <label>Station Name<span style="color:red">*</span></label> 
                                             <input type="text" name="sname" id="sname" class="form-control" placeholder="Enter Station Name">
                                  ...
                                  <div class="col-xs-12 col-sm-4 col-lg-4 col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="siofficer" id="siofficer" class="form-control"  placeholder="Enter Station Incharge Officer Name">
